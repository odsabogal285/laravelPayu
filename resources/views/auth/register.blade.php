<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <!-- Document -->
            <div>
                <x-label for="document_id" :value="__('Document')" />

                <x-input id="document_id" class="block mt-1 w-full" type="number" name="document_id" :value="old('Document')" required autofocus />
            </div>
            <!-- Name -->
            <div>
